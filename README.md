...
### [▶ 在线试玩](https://mcp.edgeone.site/share/OKL-VTb5-B3UT6WV4BcUE)
...
《弹壳地牢》是一款使用原生 `HTML5 Canvas + JavaScript` 开发的单人肉鸽动作游戏。玩家需要在房间中躲避弹幕、击败不同职责的敌人，从遗物、武器和风险路线中做出选择，逐步构筑自己的战斗流派。
...
- 4 名英雄、8 类普通敌人与 33 套 Boss 形态的真实浏览器截图验收。
